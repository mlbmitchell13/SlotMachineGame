...
/**
 * This class creates a slot machine game in test mode
 * @author Mitchell Edward Peters
 * @version 1.0.0
 */
public class Test extends Vegas {
    ...
    /**
     * This is the constructor for the test slot machine game
    ...
    public Test(Stage stage) {
        ...
        options.getItems().addAll(regular);
        ...
        Text testt = new Text("MODE: Test");
        testt.setFont(Font.font("American Typewriter", 25));
        testt.setFill(Color.YELLOW);
        testt.relocate(780, 535);
        pane.getChildren().addAll(modeRec, testt);
        //****************************************\\
